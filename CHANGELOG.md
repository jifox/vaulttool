...
- Fixed suffix fallback inference bug in `refresh` command that created files with incorrect names when vault suffix configuration changed between encryption and refresh operations.
